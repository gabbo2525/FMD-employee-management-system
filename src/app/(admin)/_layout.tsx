...
export default function AdminLayout() {
  return (
    ...
    >
      ...
      <Tabs.Screen name="employees"  options={{ title: 'Employees',  headerTitle: 'Employees',  tabBarIcon: ({ focused }) => <TabIcon emoji="👥" focused={focused} /> }} />
      <Tabs.Screen name="leaves"     options={{ title: 'Leave Approvals', headerTitle: 'Leave Approvals', tabBarIcon: ({ focused }) => <TabIcon emoji="🗓️" focused={focused} /> }} />
      <Tabs.Screen name="reports"    options={{ title: 'Reports',    headerTitle: 'Reports',    tabBarIcon: ({ focused }) => <TabIcon emoji="📊" focused={focused} /> }} />
